...
function createChemistryController({
  classCode = 'C12',
  defaultSource = CHEMISTRY_CLASS_SOURCES[classCode],
  scriptName = 'node scraper/subjects/chemistry/class-12.scraper.js'
} = {}) {
  function printUsage() {
    console.log(`Usage:
  ${scriptName}
...
`);
  ...
  function main(argv = []) {
    ...
    if (args.includes('--pyq')) {
      ...
      const options = { subject: 'chemistry', classCode };
